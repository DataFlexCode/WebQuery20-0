...
showInfoBox : function(sMessage, sCaption){
    function showInfo(tDetails){
        ...
        oDialog._oInvokingView = this._oCurrentWindow;
...
@param  sPath       Cookie path ('/' for the entire domain, '' for the current path).

@client-action
*/
setCookie : function(sName, sValue, iExpires, sPath){
    df.sys.cookie.set(sName, sValue, df.toInt(iExpires), sPath);
},
