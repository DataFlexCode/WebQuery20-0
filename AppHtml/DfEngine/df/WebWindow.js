...
_hide : function(){
    ...
    if(this._bRendered){
        if(this.pbFloating && this.pbModal){
            ...
            //  Restore the focus
            if(this._oInvokingView){    //  We return the focus to the invoking view which knows which object had the focus (this might have changed while this window is shown)
                this._oInvokingView.returnFocus();
