...
initDOM : function(){
    ...
    //  Insert
    this._eParentRef = eRef = df.sys.gui.findParentRef(this);
    if(eRef){
        eRef.appendChild(this._eSuggestions);
    }
...
suggestPosition : function(){
    var iWidth, iHeight, oRect, eSugg, eTarget, iOffsetTop, iOffsetLeft;
    ...
    if(eSugg && eTarget){
        ...
        eSugg.style.width = (this.piSuggestionWidth > 0 ? this.piSuggestionWidth : (oRect.right - oRect.left)) + "px";
